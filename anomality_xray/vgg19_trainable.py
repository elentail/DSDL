...
class Vgg19:
    ...
    def __init__(self, vgg19_npy_path=None, trainable=True, dropout=0.8):
    ...
    def build(self, rgb, train_mode=None):
        ...
        self.fc5 = self.fc_layer(self.pool4, 8192, 512, "fc5")
        ...
        self.fc6 = self.fc_layer(self.relu5, 512, 128, "fc6")
        ...
        self.logit = self.fc_layer(self.relu6, 128, 2, "fc7")
